...
(asdf:defsystem "com.informatimago.tools.summary.test"
  ;; system attributes:
  :description    "Tests the com.informatimago.tools.summary system."
  ...
  :properties     ((#:author-email . "pjb@informatimago.com")
                   (#:date . "Winter 2015")
                   ((#:albert #:output-dir)
                    . "/tmp/documentation/com.informatimago.tools.summary.test/")
  ...
  #+asdf3 :perform #+asdf3 (asdf:test-op
                            ...
                            (let ((*package* (find-package "COM.INFORMATIMAGO.TOOLS.SUMMARY.TEST")))
                              (uiop:symbol-call "COM.INFORMATIMAGO.TOOLS.SUMMARY.TEST"
                                                "TEST/ALL"))))
