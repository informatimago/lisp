...
(ASDF:DEFSYSTEM :COM.INFORMATIMAGO.CLISP :DESCRIPTION
 ...
 ((:PJB-CL-SOURCE-FILE "syslog") (:PJB-CL-SOURCE-FILE "disk")
  (:PJB-CL-SOURCE-FILE "objc") (:PJB-CL-SOURCE-FILE "string")
  (:PJB-CL-SOURCE-FILE "fifo-stream") (:PJB-CL-SOURCE-FILE "iotask")
  (:PJB-CL-SOURCE-FILE "rfc1413" :DEPENDS-ON ("iotask")))) 
