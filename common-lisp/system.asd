...
(ASDF:DEFSYSTEM :COM.INFORMATIMAGO.COMMON-LISP :DESCRIPTION
                ...
                :VERSION "1.1.377" :AUTHOR "none" :LICENCE "NIL" :DEPENDS-ON
                NIL :COMPONENTS
                ((:CL-SOURCE-FILE "package")
                 (:CL-SOURCE-FILE "source-form" :DEPENDS-ON ("package"))
                 (:CL-SOURCE-FILE "reader" :DEPENDS-ON
                  ("package" "source-form"))
                 (:CL-SOURCE-FILE "source-text" :DEPENDS-ON
                  ("package" "reader"))
                 (:CL-SOURCE-FILE "utility" :DEPENDS-ON
                  ("package" "source-form"))
                 ...
                 (:CL-SOURCE-FILE "brelation" :DEPENDS-ON
                  ("package" "bset" "utility"))
                 (:CL-SOURCE-FILE "graf" :DEPENDS-ON
                  ("package" "utility" "list"))
                 (:CL-SOURCE-FILE "graph" :DEPENDS-ON
                  ("package" "list" "utility"))
                 (:CL-SOURCE-FILE "graph-dot" :DEPENDS-ON
                  ("package" "graph" "string" "list"))
                 (:CL-SOURCE-FILE "graph-diagram" :DEPENDS-ON
                  ("package" "graph" "list"))
                 (:CL-SOURCE-FILE "combination" :DEPENDS-ON ("package"))
                 (:CL-SOURCE-FILE "pmatch" :DEPENDS-ON ("package" "utility"))
                 (:CL-SOURCE-FILE "picture" :DEPENDS-ON
                  ("package" "utility" "string"))
                 (:CL-SOURCE-FILE "memory" :DEPENDS-ON ("package"))
                 (:CL-SOURCE-FILE "heap" :DEPENDS-ON
                  ("package" "memory" "utility"))
                 (:CL-SOURCE-FILE "activity" :DEPENDS-ON ("package"))
                 (:CL-SOURCE-FILE "message-queue" :DEPENDS-ON
                  ("package" "queue"))
                 (:CL-SOURCE-FILE "float-binio" :DEPENDS-ON ("package"))
                 (:CL-SOURCE-FILE "data-encoding" :DEPENDS-ON
                  ("package" "utility"))
                 (:CL-SOURCE-FILE "cons-to-ascii" :DEPENDS-ON
                  ("package" "picture" "string"))
                 (:CL-SOURCE-FILE "tree-to-ascii" :DEPENDS-ON
                  ("package" "picture"))
                 (:CL-SOURCE-FILE "tree-to-diagram" :DEPENDS-ON
                  ("package" "list"))
                 (:CL-SOURCE-FILE "regexp-posix" :DEPENDS-ON
                  ("package" "utility"))
                 ...
                 (:CL-SOURCE-FILE "passwd" :DEPENDS-ON
                  ("package" "stream" "string"))
                 (:CL-SOURCE-FILE "group" :DEPENDS-ON
                  ("package" "stream" "string"))
