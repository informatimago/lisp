...
(DEFPACKAGE "COM.INFORMATIMAGO.COMMON-LISP.SCANNER"
...
(IN-PACKAGE "COM.INFORMATIMAGO.COMMON-LISP.SCANNER")


(eval-when (:compile-toplevel :load-toplevel :execute)
  (let ((*compile-verbose* nil)) (ecma048:generate-all-functions-in-ecma048)))

(DEFPARAMETER +C+CR+      ecma048:cr)
(DEFPARAMETER +C+LF+      ecma048:lf)
(DEFPARAMETER +NEWLINE+   (NAME-CHAR "NEWLINE"))
(DEFPARAMETER +CR+        (code-char ecma048:cr))
(DEFPARAMETER +LF+        (code-char ecma048:lf))
