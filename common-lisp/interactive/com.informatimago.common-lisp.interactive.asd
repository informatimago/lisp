...
;;;;**************************************************************************
;;;;FILE:               com.informatimago.common-lisp.interactive.asd
;;;;LANGUAGE:           Common-Lisp
;;;;SYSTEM:             Common-Lisp
;;;;USER-INTERFACE:     NONE
;;;;DESCRIPTION
;;;;    
;;;;    ASD file to load the com.informatimago.common-lisp.interactive library.
;;;;    
;;;;AUTHORS
...
(asdf:defsystem :com.informatimago.common-lisp.interactive
    ...
    :properties ((#:author-email                   . "pjb@informatimago.com")
                 (#:date                           . "Automn 2010")
                 ((#:albert #:output-dir)          . "../documentation/com.informatimago.common-lisp.interactive/")
