...
(defpackage "COM.INFORMATIMAGO.COMMON-LISP.PARSER.SCANNER"
  ...
  (:export
   ...
   "TOKEN-END-OF-SOURCE-P" "TOKEN-END-OF-SOURCE-KIND"
   ...
   ;; COMMENT-SCANNER-MIXIN
   "COMMENT-SCANNER-MIXIN" "COMMENT-SYNTAXES"
   "SINGLE-LINE-COMMENT"
   "FROM-COLUMN-COMMENT"
   "MULTI-LINE-COMMENT"
   "RECURSIVE-LINE-COMMENT"
   "COMMENT-START-TOKEN" "COMMENT-START-COLUMN" "COMMENT-STOP-TOKEN"
   "COMMENT-STARTING-P" "COMMENT-STOP-P" "SCAN-COMMENT")
  (:documentation
   "
