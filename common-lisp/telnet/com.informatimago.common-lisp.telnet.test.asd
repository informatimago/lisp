...
;;;;***************************************************************************
;;;;FILE:                com.informatimago.common-lisp.telnet.test.asd
;;;;LANGUAGE:            Common-Lisp
;;;;SYSTEM:              None
;;;;USER-INTERFACE:      None
;;;;DESCRIPTION:
;;;;
;;;;    This file defines the com.informatimago.common-lisp.telnet.test system.
...
(asdf:defsystem "com.informatimago.common-lisp.telnet.test"
  ;; system attributes:
  :description    "Tests the com.informatimago.common-lisp.telnet system."
  ...
  :properties     ((#:author-email . "pjb@informatimago.com")
                   (#:date . "Winter 2015")
                   ((#:albert #:output-dir)
                    . "/tmp/documentation/com.informatimago.common-lisp.telnet.test/")
  ...
  #+asdf3 :perform #+asdf3 (asdf:test-op
                            ...
                            (let ((*package* (find-package "COM.INFORMATIMAGO.COMMON-LISP.TELNET.TEST")))
                              (uiop:symbol-call "COM.INFORMATIMAGO.COMMON-LISP.TELNET.TEST"
                                                        "TEST/ALL"))))
