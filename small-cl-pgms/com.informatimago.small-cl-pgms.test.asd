...
;;;;***************************************************************************
;;;;FILE:                com.informatimago.small-cl-pgms.test.asd
;;;;LANGUAGE:            Common-Lisp
;;;;SYSTEM:              None
;;;;USER-INTERFACE:      None
;;;;DESCRIPTION:
;;;;
;;;;    This file defines the com.informatimago.small-cl-pgms.test system.
;;;;    Tests the com.informatimago.small-cl-pgms system.
;;;;
;;;;USAGE:
;;;;
;;;;AUTHORS:
...
(asdf:defsystem "com.informatimago.small-cl-pgms.test"
  ;; system attributes:
  :description    "Tests the com.informatimago.small-cl-pgms system."
  ...
  :properties     ((#:author-email . "pjb@informatimago.com")
                   (#:date . "Winter 2015")
                   ((#:albert #:output-dir)
                    . "/tmp/documentation/com.informatimago.small-cl-pgms.test/")
  ...
  :in-order-to ((asdf:test-op
                 ...
                 (asdf:test-op "com.informatimago.small-cl-pgms.what-implementation.test"))))
